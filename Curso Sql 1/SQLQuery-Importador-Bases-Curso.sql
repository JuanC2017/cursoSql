...
Set dateformat dmy
-- Funci�n que valida si la tabla existe, de ser asi elimina la tabla y la crea nuevamente, si la tabla no existe omite el drop y crea la tabla. 
If OBJECT_ID('tempdb..#TemporalClientes') is not null Drop Table #TemporalClientes
-- Creaci�n de tabla temporal de clientes.
...
From 
	'/home/juanlond/Desarrollo/curoSql/Curso Sql 1/BaseClientes.txt'
With
	(firstrow=2)

-- Limpiado de tabla Base Clientes.
-- IMPORTANTE: Quite el comentario de la linea truncate una vez creada la tabla Base Clientes, posterior a ello comentaree toda la sentencia de creaci�n de tabla Base Clientes. 
-- Truncate Table BaseClientes 
-- Creaci�n de tabla fisica Base Clientes. 
...
-- Inserci�n de informaci�n por medio de select a tabla Base Clientes.
...
From
	'/home/juanlond/Desarrollo/curoSql/Curso Sql 1/BaseCiudades.txt'
With
	(firstrow = 2)
...
From
	'/home/juanlond/Desarrollo/curoSql/Curso Sql 1/BaseProductos.txt'
With
	(firstrow = 2)
...
From
	'/home/juanlond/Desarrollo/curoSql/Curso Sql 1/BasePedidos.txt'
With
	(firstrow = 2)	
